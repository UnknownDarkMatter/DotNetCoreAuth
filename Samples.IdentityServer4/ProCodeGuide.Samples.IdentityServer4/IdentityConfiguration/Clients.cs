        ...
        public static IEnumerable<Client> Get()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris = new List<string> { $"{Environment.GetEnvironmentVariable("CLIENT_PROTOCOL")}://{Environment.GetEnvironmentVariable("CLIENT_HOSTNAME")}:{Environment.GetEnvironmentVariable("CLIENT_PORT")}/signin-oidc" },
