...
dans la commande executee du package json on indique le fichier de key et le certificat
    ...
    "start-pwa": "ng build --prod && angular-http-server -p 4200 --https --path dist/my-angular-boilerplate",
    "start-pwa-trusted": "ng build --prod && angular-http-server -p 4200 --https --path dist/my-angular-boilerplate --key ./ssl/localhost.key --cert ./ssl/localhost.crt"
